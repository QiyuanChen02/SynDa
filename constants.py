...
# File locations to save the density/synapse image output and generated excel file output showing the calculations for the synapses
DENSITY_IMAGE_OUTPUT_PATH = "output/densityImage.png"
SYNAPSE_IMAGE_OUTPUT_PATH = "output/synapseImage.png"
